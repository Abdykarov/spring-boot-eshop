...
public class CommonExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleItaException(ItaRequestException e, ServletWebRequest webRequest) {
        ...
        return handleExceptionInternal(e, new ItaResponseException(
                e.getMessage(),
                e.getHttpStatus(),
                e.getClass().getName(),
